...
var Review_1 = __importDefault(require("../insfrastructure/db/entities/Review"));
...
var createReview = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                newReview = _a.sent();
                return [4 /*yield*/, Product_1.default.findByIdAndUpdate(data.productId, {
