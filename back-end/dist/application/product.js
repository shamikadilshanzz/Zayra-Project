...
var Product_1 = __importDefault(require("../insfrastructure/db/entities/Product"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                newProduct = req.body;
                if (!newProduct.name) {
                    throw new validation_error_1.ValidationError("Product name is required");
                }
                if (!newProduct.price) {
                    throw new validation_error_1.ValidationError("Product price is required");
                }
                return [4 /*yield*/, Product_1.default.create(newProduct)];
            case 1:
                _a.sent();
...
var getProductById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Product_1.default.findById(req.params.id).populate("reviews", "-_id-__v")];
            case 1:
                product = _a.sent();
                if (!product) {
...
var updateProductById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Product_1.default.findByIdAndUpdate(req.params.id, req.body, { new: true })];
            case 1:
                product = _a.sent();
                if (!product) {
                    throw new not_found_error_1.NotFoundError("Product not found");
