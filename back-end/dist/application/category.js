...
var Category_1 = __importDefault(require("../insfrastructure/db/entities/Category"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!newCategory.name) {
                    throw new validation_error_1.ValidationError("Category name is required");
                }
                return [4 /*yield*/, Category_1.default.create(newCategory)];
            case 1:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                category = _a.sent();
                if (!category) {
                    throw new not_found_error_1.NotFoundError("Category not found");
                }
                res.json(category);
                return [3 /*break*/, 3];
            case 2:
...
var updateCategoryById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Category_1.default.findByIdAndUpdate(req.params.id, req.body, { new: true })];
            case 1:
                category = _a.sent();
                if (!category) {
                    throw new not_found_error_1.NotFoundError("Category not found");
